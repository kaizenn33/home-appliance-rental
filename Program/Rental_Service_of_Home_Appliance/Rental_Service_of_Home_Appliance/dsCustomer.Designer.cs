...
namespace Rental_Service_of_Home_Appliance {
    ...
    public partial class dsCustomer : global::System.Data.DataSet {
        ...
        public partial class CustomerDataTable : global::System.Data.TypedTableBase<CustomerRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public CustomerRow AddCustomerRow(string CustomerID, string CustomerName, string CustomerUsername, string CustomerPassword, string CustomerPhone, string CustomerEmail, string CustomerAddress) {
            ...
            private void InitClass() {
                ...
                this.columnCustomerPassword.MaxLength = 16;
...
namespace Rental_Service_of_Home_Appliance.dsCustomerTableAdapters {
    ...
    public partial class CustomerTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [Customer] WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_CustomerUsername = 1 AND [CustomerUsername] IS NULL) OR ([CustomerUsername] = @Original_CustomerUsername)) AND ((@IsNull_CustomerPassword = 1 AND [CustomerPassword] IS NULL) OR ([CustomerPassword] = @Original_CustomerPassword)) AND ((@IsNull_CustomerPhone = 1 AND [CustomerPhone] IS NULL) OR ([CustomerPhone] = @Original_CustomerPhone)) AND ((@IsNull_CustomerEmail = 1 AND [CustomerEmail] IS NULL) OR ([CustomerEmail] = @Original_CustomerEmail)) AND ((@IsNull_CustomerAddress = 1 AND [CustomerAddress] IS NULL) OR ([CustomerAddress] = @Original_CustomerAddress)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [Customer] ([CustomerID], [CustomerName], [CustomerUsername], [CustomerPassword], [CustomerPhone], [CustomerEmail], [CustomerAddress]) VALUES (@CustomerID, @CustomerName, @CustomerUsername, @CustomerPassword, @CustomerPhone, @CustomerEmail, @CustomerAddress);
SELECT CustomerID, CustomerName, CustomerUsername, CustomerPassword, CustomerPhone, CustomerEmail, CustomerAddress FROM Customer WHERE (CustomerID = @CustomerID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [Customer] SET [CustomerID] = @CustomerID, [CustomerName] = @CustomerName, [CustomerUsername] = @CustomerUsername, [CustomerPassword] = @CustomerPassword, [CustomerPhone] = @CustomerPhone, [CustomerEmail] = @CustomerEmail, [CustomerAddress] = @CustomerAddress WHERE (([CustomerID] = @Original_CustomerID) AND ((@IsNull_CustomerName = 1 AND [CustomerName] IS NULL) OR ([CustomerName] = @Original_CustomerName)) AND ((@IsNull_CustomerUsername = 1 AND [CustomerUsername] IS NULL) OR ([CustomerUsername] = @Original_CustomerUsername)) AND ((@IsNull_CustomerPassword = 1 AND [CustomerPassword] IS NULL) OR ([CustomerPassword] = @Original_CustomerPassword)) AND ((@IsNull_CustomerPhone = 1 AND [CustomerPhone] IS NULL) OR ([CustomerPhone] = @Original_CustomerPhone)) AND ((@IsNull_CustomerEmail = 1 AND [CustomerEmail] IS NULL) OR ([CustomerEmail] = @Original_CustomerEmail)) AND ((@IsNull_CustomerAddress = 1 AND [CustomerAddress] IS NULL) OR ([CustomerAddress] = @Original_CustomerAddress)));
SELECT CustomerID, CustomerName, CustomerUsername, CustomerPassword, CustomerPhone, CustomerEmail, CustomerAddress FROM Customer WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "select * from Customer where CustomerUsername = @cun and CustomerPassword = @cpw";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cun", global::System.Data.SqlDbType.VarChar, 50, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerUsername", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@cpw", global::System.Data.SqlDbType.VarChar, 16, global::System.Data.ParameterDirection.Input, 0, 0, "CustomerPassword", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual dsCustomer.CustomerDataTable CheckLoginCust(string cun, string cpw) {
            this.Adapter.SelectCommand = this.CommandCollection[1];
            if ((cun == null)) {
                this.Adapter.SelectCommand.Parameters[0].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[0].Value = ((string)(cun));
            }
            if ((cpw == null)) {
                this.Adapter.SelectCommand.Parameters[1].Value = global::System.DBNull.Value;
            }
            else {
                this.Adapter.SelectCommand.Parameters[1].Value = ((string)(cpw));
            }
            dsCustomer.CustomerDataTable dataTable = new dsCustomer.CustomerDataTable();
            this.Adapter.Fill(dataTable);
            return dataTable;
        ...
        public virtual int Delete(string Original_CustomerID, string Original_CustomerName, string Original_CustomerUsername, string Original_CustomerPassword, string Original_CustomerPhone, string Original_CustomerEmail, string Original_CustomerAddress) {
            ...
            if ((Original_CustomerUsername == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((string)(Original_CustomerUsername));
            }
        ...
        public virtual int Insert(string CustomerID, string CustomerName, string CustomerUsername, string CustomerPassword, string CustomerPhone, string CustomerEmail, string CustomerAddress) {
            if ((CustomerID == null)) {
            ...
            if ((CustomerUsername == null)) {
                ...
                this.Adapter.InsertCommand.Parameters[2].Value = ((string)(CustomerUsername));
            }
        ...
        public virtual int Update(string CustomerID, string CustomerName, string CustomerUsername, string CustomerPassword, string CustomerPhone, string CustomerEmail, string CustomerAddress, string Original_CustomerID, string Original_CustomerName, string Original_CustomerUsername, string Original_CustomerPassword, string Original_CustomerPhone, string Original_CustomerEmail, string Original_CustomerAddress) {
            if ((CustomerID == null)) {
                throw new global::System.ArgumentNullException("CustomerID");
            }
            else {
            ...
            if ((CustomerUsername == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[2].Value = ((string)(CustomerUsername));
            }
            if ((CustomerPassword == null)) {
            ...
            if ((Original_CustomerUsername == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[11].Value = ((string)(Original_CustomerUsername));
            }
            if ((Original_CustomerPassword == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_CustomerPassword));
            }
            if ((Original_CustomerPhone == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[15].Value = ((string)(Original_CustomerPhone));
            }
            if ((Original_CustomerEmail == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((string)(Original_CustomerEmail));
            }
            if ((Original_CustomerAddress == null)) {
        ...
        public virtual int Update(string CustomerName, string CustomerUsername, string CustomerPassword, string CustomerPhone, string CustomerEmail, string CustomerAddress, string Original_CustomerID, string Original_CustomerName, string Original_CustomerUsername, string Original_CustomerPassword, string Original_CustomerPhone, string Original_CustomerEmail, string Original_CustomerAddress) {
            return this.Update(Original_CustomerID, CustomerName, CustomerUsername, CustomerPassword, CustomerPhone, CustomerEmail, CustomerAddress, Original_CustomerID, Original_CustomerName, Original_CustomerUsername, Original_CustomerPassword, Original_CustomerPhone, Original_CustomerEmail, Original_CustomerAddress);
        }
    }
